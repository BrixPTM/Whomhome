...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<h2><?php esc_html_e( 'Join the club.', 'woocommerce' ); ?></h2>
		...
		<form method="post" class="woocommerce-form woocommerce-form-register register">
			...
			<p class="woocommerce-FormRow form-row">
				...
				<button type="submit" class="woocommerce-Button button" name="register" value="<?php esc_attr_e( 'JOIN', 'woocommerce' ); ?>"><?php esc_html_e( 'JOIN', 'woocommerce' ); ?></button>
			</p>
				<span class="bySigning"> By signing up, you are agreeing to our Terms of Use and Privacy Policy.
				</span>
